...
public class Salaam1pageActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.salaam1page);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear7.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), SalaamdatapageActivity.class);
				startActivity(i);
			}
		});
		...
		linear9.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), SallcallActivity.class);
				startActivity(i);
			}
		});
		...
		linear11.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), SalinterActivity.class);
				startActivity(i);
			}
		});
		...
		linear8.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), SallmessActivity.class);
				startActivity(i);
			}
		});
		...
		linear10.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), SallsettActivity.class);
				startActivity(i);
			}
		});
	}
