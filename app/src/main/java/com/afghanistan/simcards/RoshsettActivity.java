...
public class RoshsettActivity extends AppCompatActivity {
	...
	private MaterialCardView cardview10;
	...
	private LinearLayout linear273;
	private TextView textview58;
	private TextView textview59;
	private LinearLayout linear274;
	private LinearLayout linear275;
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.roshsett);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear268 = findViewById(R.id.linear268);
		linear269 = findViewById(R.id.linear269);
		linear270 = findViewById(R.id.linear270);
		linear271 = findViewById(R.id.linear271);
		linear272 = findViewById(R.id.linear272);
		linear273 = findViewById(R.id.linear273);
		textview58 = findViewById(R.id.textview58);
		textview59 = findViewById(R.id.textview59);
		linear274 = findViewById(R.id.linear274);
		linear275 = findViewById(R.id.linear275);
		materialbutton9 = findViewById(R.id.materialbutton9);
		linear276 = findViewById(R.id.linear276);
		...
		linear257 = findViewById(R.id.linear257);
		linear258 = findViewById(R.id.linear258);
		linear259 = findViewById(R.id.linear259);
		linear260 = findViewById(R.id.linear260);
		linear261 = findViewById(R.id.linear261);
		linear262 = findViewById(R.id.linear262);
		linear263 = findViewById(R.id.linear263);
		...
		linear264 = findViewById(R.id.linear264);
		linear265 = findViewById(R.id.linear265);
		...
		materialbutton1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				activate.setData(Uri.parse("tel:".concat("*444#".replace("#", Uri.encode("#")))));
		...
		materialbutton9.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				activate.setAction(Intent.ACTION_DIAL);
				activate.setData(Uri.parse("tel:".concat("*8#".replace("#", Uri.encode("#")))));
				startActivity(activate);
			}
		});
		...
		materialbutton4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				activate.setAction(Intent.ACTION_DIAL);
				activate.setData(Uri.parse("tel:".concat("*122#".replace("#", Uri.encode("#")))));
				startActivity(activate);
			}
		});
		...
		materialbutton5.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				activate.setData(Uri.parse("sms:".concat("200")));
				activate.putExtra("sms_body", "L 200");
				startActivity(activate);
			}
		});
				...
				if (sentmoney1.getText().toString().length() == 10) {
					if (!(sentmoney2.getText().toString().length() == 0)) {
						if (sentmoney2.getText().toString().length() < 4) {
							activate.setAction(Intent.ACTION_DIAL);
							activate.setData(Uri.parse("tel:".concat("*123*".concat(sentmoney1.getText().toString().concat("*".concat(sentmoney2.getText().toString().concat("#")))).replace("#", Uri.encode("#")))));
							startActivity(activate);
						}
						else {
				...
				if (edittext1.getText().toString().length() == 10) {
					if (!(edittext2.getText().toString().length() == 0)) {
						if (edittext2.getText().toString().length() < 4) {
							activate.setAction(Intent.ACTION_DIAL);
							activate.setData(Uri.parse("tel:".concat("*500*".concat(edittext1.getText().toString().concat("*".concat(edittext2.getText().toString().concat("#")))).replace("#", Uri.encode("#")))));
							startActivity(activate);
						}
						else {
							edittext2.setError("حداکثر 3 عدد است");
						}
					}
					else {
						edittext2.setError("لطفاً مقدار را وارد کنید!");
					}
				}
				else {
					edittext1.setError("لطفاً شماره ۱۰ رقمه را وارد کنید!");
				}
			}
		});
		...
		materialbutton3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (addcredit.getText().toString().length() == 14) {
					activate.setAction(Intent.ACTION_DIAL);
					activate.setData(Uri.parse("tel:".concat("*222*".concat(addcredit.getText().toString().concat("#")).replace("#", Uri.encode("#")))));
					startActivity(activate);
				}
				else {
		...
		materialbutton8.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				activate.setAction(Intent.ACTION_VIEW);
				activate.setData(Uri.parse("sms:".concat("555")));
				activate.putExtra("sms_body", "3G");
				startActivity(activate);
			}
		});
	}
