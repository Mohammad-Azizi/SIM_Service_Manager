...
public class Roshan1pageActivity extends AppCompatActivity {
	...
	private Intent roshandatago = new Intent();
	
	@Override
	protected void onCreate(Bundle _savedInstanceState) {
		super.onCreate(_savedInstanceState);
		setContentView(R.layout.roshan1page);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear7.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				roshandatago.setClass(getApplicationContext(), Rosd1Activity.class);
				startActivity(roshandatago);
			}
		});
		...
		linear9.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				roshandatago.setClass(getApplicationContext(), RoshcallActivity.class);
				startActivity(roshandatago);
			}
		});
		...
		linear11.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				roshandatago.setClass(getApplicationContext(), RoshinterActivity.class);
				startActivity(roshandatago);
			}
		});
		...
		linear8.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				roshandatago.setClass(getApplicationContext(), RoshmessActivity.class);
				startActivity(roshandatago);
			}
		});
		...
		linear10.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				roshandatago.setClass(getApplicationContext(), RoshsettActivity.class);
				startActivity(roshandatago);
			}
		});
	}
