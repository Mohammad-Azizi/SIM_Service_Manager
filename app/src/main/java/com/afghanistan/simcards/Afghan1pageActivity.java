...
public class Afghan1pageActivity extends AppCompatActivity {
	...
	private Intent afgdata = new Intent();
	private Intent back = new Intent();
	
	@Override
	protected void onCreate(Bundle _savedInstanceState) {
		super.onCreate(_savedInstanceState);
		setContentView(R.layout.afghan1page);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear7.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				afgdata.setClass(getApplicationContext(), Afgdatapage1Activity.class);
				startActivity(afgdata);
			}
		});
		...
		linear9.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				afgdata.setClass(getApplicationContext(), AfgmessageActivity.class);
				startActivity(afgdata);
			}
		});
		...
		linear11.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				afgdata.setClass(getApplicationContext(), AfginterActivity.class);
				startActivity(afgdata);
			}
		});
		...
		linear8.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				afgdata.setClass(getApplicationContext(), AfgmeActivity.class);
				startActivity(afgdata);
			}
		});
		...
		linear10.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				afgdata.setClass(getApplicationContext(), AfgsettActivity.class);
				startActivity(afgdata);
			}
		});
	}
