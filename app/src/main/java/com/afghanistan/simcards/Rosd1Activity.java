...
public class Rosd1Activity extends AppCompatActivity {
	...
	private class MyPagerAdapter extends androidx.viewpager.widget.PagerAdapter {
		...
		@Override public Object instantiateItem(ViewGroup collection, int position) {
			...
			if (position == 0) {
				...
				recyclerview1.setLayoutManager(new LinearLayoutManager(Rosd1Activity.this));
			} else if (position == 1) {
				...
				recyclerview2.setLayoutManager(new LinearLayoutManager(Rosd1Activity.this));
				...
				recyclerview3.setLayoutManager(new LinearLayoutManager(Rosd1Activity.this));
			} else if (position == 3) {
				...
				recyclerview4.setLayoutManager(new LinearLayoutManager(Rosd1Activity.this));
			} else if (position == 4) {
				...
				recyclerview5.setLayoutManager(new LinearLayoutManager(Rosd1Activity.this));
			}
	...
	public void _foraddvars() {
		if (lan.getString("lan", "").equals("fa")) {
			...
			s = "اجتماعی";
			            ...
			            try {
				               InputStream inputStream = getAssets().open("DProshan.json");
				               int size = inputStream.available();
				               byte[] buffer = new byte[size];
				               inputStream.read(buffer);
				               rjson = new String(buffer);
			...
			dp = "trans/DProshan.json";
			wp = "trans/WProshan.json";
			mp = "trans/MPoshan.json";
			np = "trans/NProshan.json";
			sp = "trans/SProshan.json";
			d = "Daily";
			w = "Weekly";
			m = "Monthly";
			n = "Nightly";
			s = "Social";
			            ...
			            try {
				               InputStream inputStream = getAssets().open("trans/DProshan.json");
				               int size = inputStream.available();
				               byte[] buffer = new byte[size];
				               inputStream.read(buffer);
				               rjson = new String(buffer);
