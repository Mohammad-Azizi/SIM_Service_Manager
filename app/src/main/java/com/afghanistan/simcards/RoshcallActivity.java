...
public class RoshcallActivity extends AppCompatActivity {
	...
	private LinearLayout linear483;
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.roshcall);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear482 = findViewById(R.id.linear482);
		recyclerview2 = findViewById(R.id.recyclerview2);
		linear483 = findViewById(R.id.linear483);
	...
	private class MyPagerAdapter extends androidx.viewpager.widget.PagerAdapter {
		...
		@Override public Object instantiateItem(ViewGroup collection, int position) {
				...
				if (position == 0) {
						...
						recyclerview1.setLayoutManager(new LinearLayoutManager(RoshcallActivity.this));
				} else if (position == 1) {
						...
						recyclerview2.setLayoutManager(new LinearLayoutManager(RoshcallActivity.this));
						...
						recyclerview3.setLayoutManager(new LinearLayoutManager(RoshcallActivity.this));
				} else if (position == 3) {
						...
						recyclerview4.setLayoutManager(new LinearLayoutManager(RoshcallActivity.this));
				} else if (position == 4) {
						...
						recyclerview5.setLayoutManager(new LinearLayoutManager(RoshcallActivity.this));
				}
	...
	public void _foraddvars() {
		if (lan.getString("lan", "").equals("fa")) {
			...
			s = "متفرقه";
			            ...
			            try {
				               InputStream inputStream = getAssets().open("DPCroshan.json");
				               int size = inputStream.available();
				               byte[] buffer = new byte[size];
				               inputStream.read(buffer);
				               rjson = new String(buffer);
			...
			dp = "trans/DPCroshan.json";
			wp = "trans/WPCroshan.json";
			mp = "trans/MPCroshan.json";
			np = "trans/NPCroshan.json";
			sp = "trans/OPCroshan.json";
			d = "Daily";
			w = "Weekly";
			m = "Monthly";
			n = "Nightly";
			s = "Other";
			            ...
			            try {
				               InputStream inputStream = getAssets().open("trans/DPCroshan.json");
				               int size = inputStream.available();
				               byte[] buffer = new byte[size];
				               inputStream.read(buffer);
				               rjson = new String(buffer);
