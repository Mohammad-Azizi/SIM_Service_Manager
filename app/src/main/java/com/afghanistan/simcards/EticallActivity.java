...
public class EticallActivity extends AppCompatActivity {
	...
	private LinearLayout linear464;
	private RecyclerView recyclerview2;
	private LinearLayout linear465;
	private RecyclerView recyclerview3;
	private LinearLayout linear466;
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.eticall);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear464 = findViewById(R.id.linear464);
		recyclerview2 = findViewById(R.id.recyclerview2);
		linear465 = findViewById(R.id.linear465);
		recyclerview3 = findViewById(R.id.recyclerview3);
		linear466 = findViewById(R.id.linear466);
	...
	private class MyPagerAdapter extends androidx.viewpager.widget.PagerAdapter {
			...
			@Override public Object instantiateItem(ViewGroup collection, int position) {
					...
					if (position == 0) {
							...
							recyclerview1.setLayoutManager(new LinearLayoutManager(EticallActivity.this));
					} else if (position == 1) {
							...
							recyclerview2.setLayoutManager(new LinearLayoutManager(EticallActivity.this));
							...
							recyclerview3.setLayoutManager(new LinearLayoutManager(EticallActivity.this));
					} else if (position == 3) {
							...
							recyclerview4.setLayoutManager(new LinearLayoutManager(EticallActivity.this));
					} else if (position == 4) {
							...
							recyclerview5.setLayoutManager(new LinearLayoutManager(EticallActivity.this));
					}
	...
	public void _foraddvars() {
		if (lan.getString("lan", "").equals("fa")) {
			...
			n = "شبانه";
			            ...
			            try {
				               InputStream inputStream = getAssets().open("HPCeti.json");
				               int size = inputStream.available();
				               byte[] buffer = new byte[size];
				               inputStream.read(buffer);
				               rjson = new String(buffer);
			...
			hp = "trans/HPCeti.json";
			dp = "trans/DPCeti.json";
			wp = "trans/WPCeti.json";
			mp = "trans/MPCeti.json";
			np = "trans/NPCeti.json";
			h = "Hourly";
			d = "Daily";
			w = "Weekly";
			m = "Monthly";
			n = "Nightly";
			            ...
			            try {
				               InputStream inputStream = getAssets().open("trans/HPCeti.json");
				               int size = inputStream.available();
				               byte[] buffer = new byte[size];
				               inputStream.read(buffer);
				               rjson = new String(buffer);
		...
		public void onBindViewHolder(ViewHolder _holder, final int _position) {
			...
			buttonA.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					...
					activate.setData(Uri.parse("sms:".concat("3378")));
