...
public class Etisalat1pageActivity extends AppCompatActivity {
	...
	private Intent datapagego = new Intent();
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.etisalat1page);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear7.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				datapagego.setClass(getApplicationContext(), Etid1Activity.class);
				startActivity(datapagego);
			}
		});
		...
		linear9.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				datapagego.setClass(getApplicationContext(), EticallActivity.class);
				startActivity(datapagego);
			}
		});
		...
		linear11.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				datapagego.setClass(getApplicationContext(), EtiinterActivity.class);
				startActivity(datapagego);
			}
		});
		...
		linear8.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				datapagego.setClass(getApplicationContext(), EtimessActivity.class);
				startActivity(datapagego);
			}
		});
		...
		linear10.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				datapagego.setClass(getApplicationContext(), EtisettActivity.class);
				startActivity(datapagego);
			}
		});
	}
