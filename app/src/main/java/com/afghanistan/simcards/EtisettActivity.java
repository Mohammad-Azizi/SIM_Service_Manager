...
public class EtisettActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.etisett);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		materialbutton5.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				activate.putExtra("sms_body", "SIM");
				startActivity(activate);
			}
		});
				...
				if (sentmoney1.getText().toString().length() == 10) {
					if (!(sentmoney2.getText().toString().length() == 0)) {
						if (sentmoney2.getText().toString().length() < 4) {
							activate.setAction(Intent.ACTION_DIAL);
							activate.setData(Uri.parse("tel:".concat("*125*".concat(sentmoney1.getText().toString().concat("*".concat(sentmoney2.getText().toString().concat("#")))).replace("#", Uri.encode("#")))));
							startActivity(activate);
						}
						else {
		...
		materialbutton3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (addcredit.getText().toString().length() == 14) {
					activate.setAction(Intent.ACTION_DIAL);
					activate.setData(Uri.parse("tel:".concat("*404*".concat(addcredit.getText().toString().concat("#")).replace("#", Uri.encode("#")))));
					startActivity(activate);
				}
				else {
