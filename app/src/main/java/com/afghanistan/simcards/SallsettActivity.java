...
public class SallsettActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.sallsett);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		materialbutton1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				activate.setData(Uri.parse("tel:".concat("*888#".replace("#", Uri.encode("#")))));
				...
				if (sentmoney1.getText().toString().length() == 10) {
					if (!(sentmoney2.getText().toString().length() == 0)) {
						if (sentmoney2.getText().toString().length() < 4) {
							activate.setAction(Intent.ACTION_DIAL);
							activate.setData(Uri.parse("tel:".concat("*741*".concat(sentmoney1.getText().toString().concat("*".concat(sentmoney2.getText().toString().concat("#")))).replace("#", Uri.encode("#")))));
							startActivity(activate);
						}
						else {
		...
		materialbutton5.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				activate.setAction(Intent.ACTION_DIAL);
				activate.setData(Uri.parse("tel:".concat("*742#".replace("#", Uri.encode("#")))));
				startActivity(activate);
			}
		});
		...
		materialbutton3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (addcredit.getText().toString().length() == 14) {
					activate.setAction(Intent.ACTION_DIAL);
					activate.setData(Uri.parse("tel:".concat("*777*".concat(addcredit.getText().toString().concat("#")).replace("#", Uri.encode("#")))));
					startActivity(activate);
				}
				else {
		...
		materialbutton4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				activate.putExtra("sms_body", "DATA");
				startActivity(activate);
			}
		});
	}
