...
public final class EticallBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final LinearLayout linear464;

  @NonNull
  public final LinearLayout linear465;
  ...
  private EticallBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout AppBar,
      ...
      @NonNull LinearLayout linear4, @NonNull LinearLayout linear464,
      @NonNull LinearLayout linear465, @NonNull LinearLayout linear466,
      @NonNull LinearLayout linear467, @NonNull RecyclerView recyclerview1,
    ...
    this.linear464 = linear464;
    this.linear465 = linear465;
  ...
  @NonNull
  public static EticallBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static EticallBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.eticall, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EticallBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.linear464;
      LinearLayout linear464 = ViewBindings.findChildViewById(rootView, id);
      if (linear464 == null) {
        break missingId;
      }

      id = R.id.linear465;
      LinearLayout linear465 = ViewBindings.findChildViewById(rootView, id);
      if (linear465 == null) {
        break missingId;
      }
      ...
      return new EticallBinding((CoordinatorLayout) rootView, AppBar, Coordinator, Toolbar, base,
          layout1, layout2, layout3, layout4, layout5, linear1, linear4, linear464, linear465,
          linear466, linear467, recyclerview1, recyclerview2, recyclerview3, recyclerview4,
