...
public final class MtmessBinding implements ViewBinding {
  @NonNull
  ...
  private MtmessBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout AppBar,
  ...
  @NonNull
  public static MtmessBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static MtmessBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.mtmess, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MtmessBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MtmessBinding((CoordinatorLayout) rootView, AppBar, Coordinator, Toolbar, base,
