...
public final class AfgmeBinding implements ViewBinding {
  @NonNull
  ...
  private AfgmeBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout AppBar,
  ...
  @NonNull
  public static AfgmeBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static AfgmeBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.afgme, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AfgmeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AfgmeBinding((CoordinatorLayout) rootView, AppBar, Coordinator, Toolbar, base,
          layout1, layout2, layout3, layout4, layout5, linear1, linear4, linear5, linear6, linear7,
          linear8, recyclerview1, recyclerview2, recyclerview3, recyclerview4, recyclerview5,
          tablayout, trash);
    }
