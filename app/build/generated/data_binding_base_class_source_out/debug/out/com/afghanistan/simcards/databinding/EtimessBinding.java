...
public final class EtimessBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final LinearLayout linear437;

  @NonNull
  public final LinearLayout linear438;

  @NonNull
  public final LinearLayout linear439;

  @NonNull
  public final LinearLayout linear440;
  ...
  private EtimessBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout AppBar,
      ...
      @NonNull LinearLayout linear4, @NonNull LinearLayout linear437,
      @NonNull LinearLayout linear438, @NonNull LinearLayout linear439,
      @NonNull LinearLayout linear440, @NonNull RecyclerView recyclerview1,
    ...
    this.linear437 = linear437;
    this.linear438 = linear438;
    this.linear439 = linear439;
    this.linear440 = linear440;
  ...
  @NonNull
  public static EtimessBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static EtimessBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.etimess, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EtimessBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.linear437;
      LinearLayout linear437 = ViewBindings.findChildViewById(rootView, id);
      if (linear437 == null) {
        break missingId;
      }

      id = R.id.linear438;
      LinearLayout linear438 = ViewBindings.findChildViewById(rootView, id);
      if (linear438 == null) {
        break missingId;
      }

      id = R.id.linear439;
      LinearLayout linear439 = ViewBindings.findChildViewById(rootView, id);
      if (linear439 == null) {
        break missingId;
      }

      id = R.id.linear440;
      LinearLayout linear440 = ViewBindings.findChildViewById(rootView, id);
      if (linear440 == null) {
        break missingId;
      }
      ...
      return new EtimessBinding((CoordinatorLayout) rootView, AppBar, Coordinator, Toolbar, base,
          layout1, layout2, layout3, layout4, layout5, linear1, linear4, linear437, linear438,
          linear439, linear440, recyclerview1, recyclerview2, recyclerview3, recyclerview4,
