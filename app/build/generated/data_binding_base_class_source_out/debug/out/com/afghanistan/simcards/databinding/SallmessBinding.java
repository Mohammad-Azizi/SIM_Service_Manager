...
public final class SallmessBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final LinearLayout linear419;

  @NonNull
  public final LinearLayout linear420;

  @NonNull
  public final LinearLayout linear421;

  @NonNull
  public final LinearLayout linear422;
  ...
  private SallmessBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout AppBar,
      ...
      @NonNull LinearLayout linear4, @NonNull LinearLayout linear419,
      @NonNull LinearLayout linear420, @NonNull LinearLayout linear421,
      @NonNull LinearLayout linear422, @NonNull RecyclerView recyclerview1,
    ...
    this.linear419 = linear419;
    this.linear420 = linear420;
    this.linear421 = linear421;
    this.linear422 = linear422;
  ...
  @NonNull
  public static SallmessBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SallmessBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.sallmess, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SallmessBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.linear419;
      LinearLayout linear419 = ViewBindings.findChildViewById(rootView, id);
      if (linear419 == null) {
        break missingId;
      }

      id = R.id.linear420;
      LinearLayout linear420 = ViewBindings.findChildViewById(rootView, id);
      if (linear420 == null) {
        break missingId;
      }

      id = R.id.linear421;
      LinearLayout linear421 = ViewBindings.findChildViewById(rootView, id);
      if (linear421 == null) {
        break missingId;
      }

      id = R.id.linear422;
      LinearLayout linear422 = ViewBindings.findChildViewById(rootView, id);
      if (linear422 == null) {
        break missingId;
      }
      ...
      return new SallmessBinding((CoordinatorLayout) rootView, AppBar, Coordinator, Toolbar, base,
          layout1, layout2, layout3, layout4, layout5, linear1, linear4, linear419, linear420,
          linear421, linear422, recyclerview1, recyclerview2, recyclerview3, recyclerview4,
