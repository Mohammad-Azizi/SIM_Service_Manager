...
public final class RoshcallBinding implements ViewBinding {
  @NonNull
  ...
  private RoshcallBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout AppBar,
  ...
  @NonNull
  public static RoshcallBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RoshcallBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.roshcall, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RoshcallBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RoshcallBinding((CoordinatorLayout) rootView, AppBar, Coordinator, Toolbar, base,
