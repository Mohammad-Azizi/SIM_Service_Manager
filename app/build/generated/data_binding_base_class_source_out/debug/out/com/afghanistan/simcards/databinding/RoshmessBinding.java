...
public final class RoshmessBinding implements ViewBinding {
  @NonNull
  ...
  private RoshmessBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout AppBar,
  ...
  @NonNull
  public static RoshmessBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RoshmessBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.roshmess, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RoshmessBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RoshmessBinding((CoordinatorLayout) rootView, AppBar, Coordinator, Toolbar, base,
