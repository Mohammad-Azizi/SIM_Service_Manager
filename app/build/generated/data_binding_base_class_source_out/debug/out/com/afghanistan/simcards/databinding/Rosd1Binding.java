...
public final class Rosd1Binding implements ViewBinding {
  @NonNull
  ...
  private Rosd1Binding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout AppBar,
      ...
      @NonNull LinearLayout linear4, @NonNull LinearLayout linear509,
  ...
  @NonNull
  public static Rosd1Binding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static Rosd1Binding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.rosd1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Rosd1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Rosd1Binding((CoordinatorLayout) rootView, AppBar, Coordinator, Toolbar, base,
          layout1, layout2, layout3, layout4, layout5, linear1, linear4, linear509, linear510,
